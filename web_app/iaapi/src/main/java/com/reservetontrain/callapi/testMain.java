...
public class testMain {
    ...
    public static void main(String[] args) {
        ...
        byte[] reader = mytestApi.getApiInfo("http://51.255.1.76:3000/api/Stations");
        ...
        reader = mytestApi.getApiInfo("http://51.255.1.76:3000/api/Trips");
        mytestApi.reader_to_trees(reader, ltrips);

        reader = mytestApi.getApiInfo("http://51.255.1.76:3000/api/Schedules");
...
/*
		...
		*/
        ...
        JSONObject jsonr;
        ia = new Ia("http://51.255.1.76:3000/api/");
        TreeMap<Integer, ArrayList<Integer>> test = ia.getshortesttrips("PalombieForest", "BatCave");
